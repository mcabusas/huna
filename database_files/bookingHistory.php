<?php
    ...
    if($page == 0){
        $query = "SELECT b.booking_id, u.username, u.user_firstName, u.user_lastName, t.rate, b.booking_status, b.date from        booking AS b
    ...
    if(mysqli_num_rows($ret) == 0){
        $json['message'] = "You have no bookings";
    }else{
