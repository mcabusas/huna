...
class TutorProfilePage extends StatefulWidget {
  final tutorInfo, userID;

  TutorProfilePage({Key key, this.tutorInfo, this.userID});
  @override
...
class _TutorProfileState extends State<TutorProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TutorProfileWidget(tutorInformation: widget.tutorInfo),
    );
  }
}

class TutorProfileWidget extends StatefulWidget {
  final tutorInformation;

  const TutorProfileWidget({Key key, this.tutorInformation}); 
          ...
          child: Align(
            ...
            child: Column(
              children: <Widget>[
                ...
                Center(
                  child: Text(
                    "${widget.tutorInformation['user_firstName']} ${widget.tutorInformation['user_lastName']}",
                ...
                Center(
                  child: Text(
                    "${widget.tutorInformation['username']}",
                    //'@${data[0]['username']}',
                    ...
                    Padding(
                      ...
                      child: Card(
                        child: ListTile(
                          ...
                          title: Text(
                            "P ${widget.tutorInformation['rate']}",
                            //"P ${data[0]['rate']}.00",
